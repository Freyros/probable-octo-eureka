...
(function() {
        ...
        room: {
            ...
            roulette: {
              ...
              endRoulette: function () {
                    ...
                    var pozice_ve_fronte = ["1"];
                    var pos = pozice_ve_fronte[Math.floor(Math.random() * pozice_ve_fronte.length)];
 ...
 "balls": [
    ...
    "69",
    "Co myslíš, že by na to řekl Germ?",
...
"nodatafound": "Nebyla nalezena žádná předchozí data.",
    ...
    "welcome": "/me Vítej a cíť sa tu ako doma. <3 @%%NAME%%",
    ...
    "isopen": "/me Ruleta je spuštěna! Napiš !join pro přihlášení! (Hra, při které za pomocí slosování, můžeš být hozen/a na 1 až 5 pozici ve frontě.)",
    ...
    "move": "/me [%%NAME%% přesunuje pozici ve frontě]",
    ...
    "unmuted": "/me [@%%NAME%%] Odmlčel/a @%%USERNAME%%.",
    ...
    "prikazy": "/me Seznam DN příkazů: https://github.com/JokerSvK/DN-Bot/blob/master/prikazy.md",
    ...
    "afk": "/me %%NAME%% Išiel / išla na nejakú dobu preč od PC. <3",
    ...
    "zpet": "/me %%NAME%% se vrátil/a zpět k PC. <3",
